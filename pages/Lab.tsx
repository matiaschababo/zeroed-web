    ...
    return (
        <div className="container mx-auto px-6 md:px-12 pt-32 pb-20">
            ...
            >
                ...
                <h1 className="text-5xl md:text-7xl font-['Space_Grotesk'] font-bold text-white uppercase">{t('rd_division')}</h1>
                <p className="text-gray-500 font-mono mt-4">{t('rd_desc')}</p>
            </motion.div>
            ...
            <div className="space-y-24">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center border border-white/10 p-8 lg:p-12 bg-[#080808] relative overflow-hidden">
                    ...
                    >
                        ...
                        <h2 className="text-3xl md:text-4xl text-white font-['Space_Grotesk'] font-bold mb-4">{t('zeroed_analytics_hub')}</h2>
                        <h3 className="text-white/70 text-xl font-bold mb-6">{t('cross_platform_attribution')}</h3>
                        ...
                        <div className="p-4 border border-white/10 bg-black/50 backdrop-blur-sm">
                            <p className="text-[#FF5F00] text-sm font-bold mb-1">{t('why_it_matters')}</p>
                            <p className="text-gray-400 text-xs">{t('hub_why')}</p>
                        </div>
                    </motion.div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center border border-white/10 p-8 lg:p-12 bg-[#080808]">
                    ...
                    >
                        ...
                        <h2 className="text-3xl md:text-4xl text-white font-['Space_Grotesk'] font-bold mb-4">{t('seo_script_gen')}</h2>
                        <h3 className="text-white/70 text-xl font-bold mb-6">{t('automated_content')}</h3>
                        <p className="text-gray-400 font-mono text-sm leading-relaxed mb-6">
                            {t('script_desc')}
                        </p>
                        <div className="p-4 border border-white/10 bg-black/50 backdrop-blur-sm">
                            <p className="text-[#FF5F00] text-sm font-bold mb-1">{t('why_it_matters')}</p>
                            <p className="text-gray-400 text-xs">{t('script_why')}</p>
                        </div>
                    </motion.div>
                </div>
