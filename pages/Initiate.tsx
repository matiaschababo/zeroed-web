    ...
    if (status === 'sent') {
        return (
            <div className="container mx-auto px-6 pt-32 h-screen flex flex-col items-center justify-center text-center">
                ...
                >
                    <h2 className="text-3xl text-[#FF5F00] font-mono font-bold mb-4">{t('transmission_complete')}</h2>
                    <p className="text-white font-mono text-sm">{t('operatives_analyze')}</p>
                    <p className="text-gray-500 font-mono text-xs mt-4">{t('stand_by')}</p>
                    <button onClick={() => setStatus('idle')} className="mt-8 text-white underline font-mono text-xs hover:text-[#FF5F00]" data-hover="true">{t('new_transmission')}</button>
                </motion.div>
            </div>
        )
    }
        ...
        <div className="container mx-auto px-6 md:px-12 pt-32 pb-20 min-h-screen flex flex-col justify-center">
            <div className="max-w-3xl mx-auto w-full">
                <motion.div
                    ...
                    className="mb-8"
                >
                    <h1 className="text-5xl font-['Space_Grotesk'] font-bold text-white uppercase mb-2">{t('initiate_protocol')}</h1>
                    <p className="text-gray-500 font-mono text-xs">{t('secure_line')}</p>
                </motion.div>
                ...
                >
                    ...
                    <div className="space-y-8 font-mono">
                        <div className="group">
                            <label className="block text-[#FF5F00] text-xs mb-2 tracking-widest">{t('enter_id')}</label>
                        ...
                        <div className="group">
                            <label className="block text-[#FF5F00] text-xs mb-2 tracking-widest">{t('target_url')}</label>
                        ...
                        <div className="group">
                            <label className="block text-[#FF5F00] text-xs mb-4 tracking-widest">{t('select_protocol')}</label>
                        ...
                        <div className="group">
                            <label className="block text-[#FF5F00] text-xs mb-2 tracking-widest">{t('mission_brief')}</label>
