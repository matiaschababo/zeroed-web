    ...
    <div className="w-full min-h-screen pt-20 pb-12 flex flex-col relative overflow-hidden">
      ...
      >
        ...
        <div className="inline-flex items-center gap-3 border border-white/10 rounded-full px-4 py-1.5 mb-8 bg-white/5 backdrop-blur-sm">
            ...
            <p className="text-zinc-400 font-['Inter'] text-xs tracking-widest uppercase font-medium">Protocol: Z-01 // Online</p>
        </div>
        ...
        <h1 className="text-7xl md:text-9xl font-['Space_Grotesk'] font-black tracking-tighter leading-[0.9] mb-8 select-none relative z-10">
          <div className="text-white">PRECISION</div>
        ...
        <p className="text-zinc-400 max-w-2xl text-lg font-['Inter'] mb-12 leading-relaxed font-light relative z-10">
          Data-Driven Growth for Creators & High-Risk Brands. <br className="hidden md:block"/>We eliminate visual chaos to maximize signal.
        </p>
        ...
        <div className="container mx-auto px-6 md:px-12 flex flex-col items-center">
            ...
            <div className="w-full max-w-4xl border border-[#FF5F00]/30 bg-[#050505] shadow-[0_0_50px_rgba(255,95,0,0.1)]">
                ...
                <div className="p-8 font-mono text-sm md:text-base space-y-4">
                    <p className="text-[#FF5F00] font-bold mb-4">CRITICAL ERROR DETECTED: SIGNAL_LOSS</p>
                    <div className="space-y-2 text-zinc-400">
                        ...
                        <p className="flex gap-3">
                            ...
                            <span>Analysis: <span className="text-white">Great Content + Bad Packaging</span> == <span className="text-[#FF5F00]">0 Views</span></span>
                        </p>
                        <p className="flex gap-3">
                            <span className="text-zinc-600">003</span>
                            <span>Analysis: <span className="text-white">High Ad Spend + Generic Creative</span> == <span className="text-[#FF5F00]">Negative ROI</span></span>
                        </p>
                        <p className="flex gap-3 mt-4 text-[#FF5F00]">
                            <span className="text-zinc-600">004</span>
                            <span>Fixing signal... <span className="inline-block w-2 h-4 bg-[#FF5F00] animate-blink align-middle ml-1"></span></span>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="mt-12 text-center">
                 <p className="text-white font-['Space_Grotesk'] text-xl md:text-2xl font-bold">The market doesn't ignore content. <span className="text-zinc-500">It ignores noise.</span></p>
            </div>
        </div>
      </motion.div>
      ...
      <div className="container mx-auto px-6 md:px-12 mt-12 pb-12 relative z-10">
        <div className="flex items-center gap-4 mb-12">
            ...
            <span className="text-zinc-500 font-['Inter'] text-xs uppercase tracking-widest font-semibold">Operational Capabilities</span>
            <div className="h-[1px] bg-white/10 flex-grow"></div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 auto-rows-[300px]">
          ...
          <HomeSpotlightCard className="md:col-span-2 flex flex-col justify-between" onClick={() => setPage(Page.OPS)}>
            ...
            <div>
                <h3 className="text-2xl font-bold font-['Space_Grotesk'] text-white mb-3 uppercase">YouTube Ops</h3>
                <p className="text-zinc-400 font-['Inter'] text-sm leading-relaxed max-w-md">Complete channel architecture. Retention engineering, SEO injection, and thumbnail CTR maximization.</p>
            </div>
          </HomeSpotlightCard>
          ...
          <HomeSpotlightCard className="flex flex-col justify-between" onClick={() => setPage(Page.OPS)}>
            ...
            <div>
                <h3 className="text-2xl font-bold font-['Space_Grotesk'] text-white mb-3 uppercase">Paid Warfare</h3>
                <p className="text-zinc-400 font-['Inter'] text-sm leading-relaxed">Aggressive Meta & TikTok scaling protocols.</p>
            </div>
          </HomeSpotlightCard>
           ...
           <HomeSpotlightCard className="flex flex-col justify-between" onClick={() => setPage(Page.OPS)}>
            ...
            <div>
                <h3 className="text-2xl font-bold font-['Space_Grotesk'] text-white mb-3 uppercase">Data Intel</h3>
                <p className="text-zinc-400 font-['Inter'] text-sm leading-relaxed">Attribution beyond standard pixels. Server-side tracking.</p>
            </div>
          </HomeSpotlightCard>
           ...
           <HomeSpotlightCard className="md:col-span-2 flex items-center justify-center bg-[#111]" onClick={() => setPage(Page.LOGS)}>
                <div className="text-center group-hover:scale-105 transition-transform duration-300">
                    <p className="text-[#FF5F00] font-['Inter'] text-xs mb-3 font-semibold tracking-wider">VALIDATED RESULTS</p>
                    <h3 className="text-3xl md:text-4xl font-black font-['Space_Grotesk'] text-white uppercase">
                        View Mission Logs <ArrowRight className="inline ml-2" />
                    </h3>
                </div>
           </HomeSpotlightCard>
        </div>
