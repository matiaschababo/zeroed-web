...
export const Logs: React.FC = () => {
  return (
    <div className="container mx-auto px-6 md:px-12 pt-32 pb-20">
      ...
      >
        <h1 className="text-5xl md:text-7xl font-['Space_Grotesk'] font-bold text-white uppercase mb-2">Mission Logs</h1>
        <p className="text-gray-500 font-mono text-sm">Verified results from field operations.</p>
      </motion.div>
      ...
      <div className="grid grid-cols-1 gap-0 border-t border-white/10">
          ...
          >
            <div className="flex flex-col md:flex-row items-baseline justify-between gap-6 relative z-10">
              ...
              <div className="flex-1 md:text-center">
                 <span className="text-xs text-gray-500 font-mono block mb-1">Objective</span>
            ...
            <div className="absolute top-1/2 right-12 transform -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-all duration-300 translate-x-10 group-hover:translate-x-0">
               <span className="font-mono text-white text-xs border border-white/20 px-4 py-2">Access File</span>
            </div>
          </motion.div>
        ))}
      </div>
       ...
       <div className="mt-24">
        <h3 className="text-white text-3xl font-['Space_Grotesk'] font-bold text-center mb-12 uppercase">Recent Deployments</h3>
